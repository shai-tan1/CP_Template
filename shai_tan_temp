...
long long fact[2005], invFact[2005];
// global variables
...
signed main() {
    ...
    // this will make all the factorials of 1->300000,
    // used in computing ncr
    ...
    //     }
    // }
    // take this section of code and paste in solve, to get the precomputed sparse table
    // tweek the max to min to find the min of a range
    // used to find max of a range l - r in O(1) call
